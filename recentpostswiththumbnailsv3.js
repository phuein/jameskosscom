...
if (entry.link[k].rel == 'alternate') {console.log('namelink='+namelink); posturl = entry.link[k].href + namelink;break;}}var thumburl;try {thumburl=entry.media$thumbnail.url;}catch (error)
...
if (thumburl) document.write('<img class="recent_thumb" src="'+thumburl+'"/>');
